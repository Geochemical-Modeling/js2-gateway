export default function FileInput({legend, label, required, id, onChange, name, accept}) {
  return (
    <fieldset className="rvt-fieldset">
      <legend className="rvt-m-bottom-sm">{legend}
          {required && (
      ...
      <div className="rvt-file" data-rvt-file-input={id}>
        ...
        <div className="rvt-file__preview" data-rvt-file-input-preview={id} id={`file-${id}-description`}>
          No file selected
        </div>
      </div>
    </fieldset>
