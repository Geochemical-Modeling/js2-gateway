...
def run_phreeqc_process(exp_id: str, binary_path: str, input_data: str, output_file_dir: str, 
                       files: list, output_dir: str, output_file_name: str, lock_file_path: str):
    """
    ...
    try:
        ...
        try:
            stdout, stderr = process.communicate(input=input_data, timeout=1200)  # 20 minute timeout (1200 seconds)
            
            if process.returncode != 0:
                update_lock_file(lock_file_path, "error", f"Process failed with error: {stderr}")
                return
...
def start_phreeqc_job(exp_id: str, binary_path: str, input_data: str, output_file_dir: str, 
                     files: list, output_dir: str, output_file_name: str):
    """
    ...
    thread = threading.Thread(
        ...
        args=(exp_id, binary_path, input_data, output_file_dir, files, output_dir, output_file_name, lock_file_path)
    )
